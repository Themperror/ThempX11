...
namespace Themp
{
	ShadowUnfiltered::ShadowUnfiltered()
	{
		...
		m_UnfilteredLightingMaterial = Resources::TRes->GetMaterial("DeferredLightingUnfiltered", "", "DeferredLightingPCF", true, true, false);
	...
	void ShadowUnfiltered::AddDirectionalLight(XMFLOAT4 pos, XMFLOAT4 dir, XMFLOAT4 color, int resolution)
	{
	...
	void ShadowUnfiltered::SetDirectionalLight(int index, XMFLOAT4 pos, XMFLOAT4 dir, XMFLOAT4 color)
	{
		m_DirtyLights = true;
		m_ShadowMaps[index].LightIsDirty = true;
